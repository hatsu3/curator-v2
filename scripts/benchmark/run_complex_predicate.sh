...
# Unified Complex Predicate Search Evaluation Script
# Supports running individual baseline algorithms or all baselines for comparison
# Usage: ./run_complex_predicate.sh <baseline_name> [output_dir]
...
cat > "${CONFIG_FILE}" << EOF
{
  ...
  "algorithm_parameters": {
    ...
    "acorn": {
      ...
      "search_ef_space": [8, 16, 32, 64, 128],
...
run_baseline() {
    ...
    case $algo in
        "curator")
            ...
            ;;
        "curator_with_index")
            python -m benchmark.complex_predicate.curator_with_index \
            ...
            ;;
        "shared_hnsw")
            python -m benchmark.complex_predicate.shared_hnsw \
            ...
            ;;
        "per_predicate_hnsw")
            python -m benchmark.complex_predicate.per_predicate_hnsw \
            ...
            ;;
        "shared_ivf")
            python -m benchmark.complex_predicate.shared_ivf \
            ...
            ;;
        "per_predicate_ivf")
            python -m benchmark.complex_predicate.per_predicate_ivf \
            ...
            ;;
        "parlay_ivf")
            python -m benchmark.complex_predicate.parlay_ivf \
        ...
        "acorn")
            ...
            python -m benchmark.complex_predicate.acorn \
