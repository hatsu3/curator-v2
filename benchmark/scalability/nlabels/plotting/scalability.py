# Update filtered diskann results, add ACORN-1 and ACORN-gamma results
...
from benchmark.scalability.plotting import select_best_result
from benchmark.scalability_nvec.plotting import load_all_results, select_best_config
...
def plot_memory_vs_nlabel_at_ax(
    ...
    color_map: dict[str, str] | str = "tab10",  # tab10: default colors
    marker_map: dict[str, str] | bool = True,  # True: default markers
    marker_size: int = 6,
    line_width: float = 1,
):
