...
for symbol in dir(this_module):
    ...
    if inspect.isclass(obj):
        ...
        if issubclass(the_class, MultiTenantIndex):
            class_wrappers.handle_MultiTenantIndex(the_class)
...
add_ref_in_constructor(MultiTenantIndexIVF, 0)
add_ref_in_constructor(MultiTenantIndexIVFFlat, 0)
add_ref_in_constructor(MultiTenantIndexIVFFlatBF, 0)
add_ref_in_constructor(MultiTenantIndexIVFFlatSep, 0)
add_ref_in_constructor(MultiTenantIndexIVFHierarchical, 0)
add_ref_in_constructor(IndexACORNFlat, 0)
add_ref_in_constructor(HybridCurator, 0)
add_ref_in_constructor(MultiTenantIndexHNSW, 0)
