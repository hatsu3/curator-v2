...
struct ACORN {
    ...
    **************************************************************/
    ...
    void print_neighbor_stats(bool edge_list, bool filtered_edge_list=false, int filter=-1, Operation op=EQUAL) const; //overloaded
    ...
    void shrink_neighbor_list(
            ...
            int max_size, int gamma = 1, storage_idx_t q_id = 0, int q_attr = 0);
};
